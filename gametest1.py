            ...
            for card_name in card_names:
                ...
                if rank != "Closed Card":
                    ...
                    if card_value is None:
                        ...
                        if len(player_hand) < 2:  # Distribute first two cards to player
                            player_hand.append(card)
                        else:  # Distribute the rest to dealer
                            dealer_hand.append(card)
                        print(f"Card: {card_name}, Value: {card_value}")
...
while True:
    ...
    if not game_over:
        ...
        player_hand, dealer_hand =  handle_detected_cards(detected_cards)
